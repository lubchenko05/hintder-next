...
/* ─────────────────────────────────────────────
   GuideListPage — one page of the guides archive. /guides renders page 1,
   /guides/page/[n] the rest; both use this so the two routes can't drift.
   ───────────────────────────────────────────── */

export const GUIDES_PER_PAGE = 24;
      ...
      <main className="flex-1 pt-32 pb-24">
        ...
        <section className="px-5 sm:px-8">
          <div className="mx-auto max-w-7xl">
            ...
            <Pager base="/guides" page={page} hasMore={hasMore} />
          </div>
        </section>
