...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-bg disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        default:
          "gradient-accent text-white shadow-lg shadow-accent/20 hover:shadow-accent/30 hover:brightness-110 active:brightness-95",
        outline:
          "border border-border bg-transparent text-text hover:bg-glass hover:border-border-hover",
        ghost:
          "text-text-secondary hover:bg-glass hover:text-text",
        accent:
          "bg-accent text-white hover:bg-accent-hover active:brightness-95",
        violet:
          "bg-violet text-white hover:brightness-110 active:brightness-95",
        destructive:
          "bg-red-600 text-white hover:bg-red-500 active:brightness-95",
