...
date: "2026-05-26"
persona: "Marcus & Lena · Berlin"
readTime: "5 min"
blocks:
  - type: opener
    eyebrow: "the message that started everything"
    opener: "Flat white, no sugar, oat. If I'm wrong on any of that please end it now."
    meta: "she replied in eight minutes"
  - type: thread
    eyebrow: "the eight minutes that changed his year"
    messages:
      - { role: "me", text: "Flat white, no sugar, oat. If I'm wrong on any of that please end it now." }
      - { role: "her", text: "Oat is a stretch but I'll allow it. The bigger question is who hurt you that you needed to lead with this" }
      - { role: "me", text: "A barista in 2019. Recovery has been slow. Where do good ones live in Mitte these days?" }
      - { role: "her", text: "Five Elephant. Bonanza if you're feeling industrial." }
      - { role: "me", text: "Five Elephant Saturday? You can grade my order in person." }
      - { role: "her", text: "Deal. But I'm a harsh marker." }
  - type: timeline
    eyebrow: "eleven months, give or take"
    milestones:
      - { when: "that saturday", title: "Two hours at Five Elephant", note: "They closed the place. She graded his order a 6. He's still appealing it." }
      - { when: "three weeks in", title: "She left a toothbrush at his", note: "He didn't say anything — just started buying the oat milk she likes." }
      - { when: "month five", title: "Met each other's friends in one week", note: "Both sets said the same thing: you two already sound like an old couple." }
      - { when: "now", title: "Picking a sofa together", note: "The argument is grey vs. green. The coffee order is settled." }
  - type: quote
    quote: "I almost didn't send it. I'd typed and deleted three boring versions first. The line that worked was the one that actually sounded like me — and somehow that's the version of me she fell for."
    attribution: "Marcus, Berlin"
---
