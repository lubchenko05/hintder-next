...
category: "Love story"
date: "2026-05-19"
persona: "James & Maya · San Francisco"
readTime: "4 min"
blocks:
  - type: opener
    eyebrow: "where it began — a strong opinion about lunch"
    opener: "Sweetgreen is a war crime and we both know it. Where's the upgrade?"
    meta: "she answered in under a minute"
  - type: thread
    eyebrow: "the conversation that didn't cool off"
    messages:
      - { role: "her", text: "I'd rather die than get coffee with someone who picks Sweetgreen." }
      - { role: "me", text: "Sweetgreen is a war crime and we both know it. Where's the upgrade?" }
      - { role: "her", text: "Souvla. Always Souvla. I'll die on this hill." }
      - { role: "me", text: "Death by lamb sandwich. Worse ways to go. Friday?" }
      - { role: "her", text: "Now you're getting it. Friday." }
  - type: timeline
    eyebrow: "a year, one sandwich at a time"
    milestones:
      - { when: "first friday", title: "Souvla, then a second place, then a third", note: "Neither of them wanted to go home. They split a third dinner just to keep talking." }
      - { when: "two months", title: "A drawer at her place", note: "The 'good with people, terrible at staying' guy stopped wanting to leave." }
      - { when: "month seven", title: "A trip to her hometown", note: "He met her grandmother, who fed him until he physically could not move." }
      - { when: "now", title: "Same apartment, lamb sandwich every Friday", note: "It's their thing. Non-negotiable. He still pretends to argue for Sweetgreen just to make her laugh." }
  - type: quote
    quote: "For years every message felt load-bearing, like one wrong word would end it. With Maya I just said the thing I actually thought — and she was right there, throwing it back. I didn't know it could be that easy. It's still that easy."
    attribution: "James, San Francisco"
---
